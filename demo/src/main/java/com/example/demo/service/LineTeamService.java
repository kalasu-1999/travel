...
public interface LineTeamService {
    //添加路线-旅行团对应信息
    int insertLineTeam(Integer teamId, Integer lineId, String goDate, String backDate);

    //修改路线-旅行团对应信息
    int updateLineTeam(Integer lineteamId, Integer teamId, Integer lineId, String goDate, String backDate, Integer adult, Integer child);
    ...
    //多条件查询
    List<LineTeam> selectLineTeamByMore(Integer lineteamId, Integer teamId, Integer lineId, String goDate, String backDate, Integer adult, Integer child);
